<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminGununYemegi.aspx.cs" Inherits="YemekTarifiSite.AdminGununYemegi" %>
                ...
                <table class="auto-style2">
                    <tr>
                        ...
                        <td class="auto-style5">
                            <a href="AdminGununYemegi.aspx?Yemekid=<%# Eval("Yemekid") %>&islem=sec">
                            <asp:Image ID="Image3" runat="server" Height="30px" ImageUrl="~/resimler/choice.jpg" Width="30px" />
                            </a>
                        </td>
                    </tr>
                </table>
