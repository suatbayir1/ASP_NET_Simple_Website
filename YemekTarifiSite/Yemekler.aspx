    ...
    <asp:Panel ID="Panel3" runat="server">
        <table class="auto-style2">
            ...
            <tr>
                <td>KATEGORİ :</td>
                <td>
                    <asp:DropDownList ID="ddKategori" runat="server" Width="300px">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                ...
                <td class="auto-style11"><strong>
                    <asp:Button ID="btnKategoriEkle0" runat="server" CssClass="auto-style9" Text="Ekle" Width="100px" OnClick="btnKategoriEkle0_Click" />
                    </strong></td>
            </tr>
            <tr>
                <td>&nbsp;</td>
